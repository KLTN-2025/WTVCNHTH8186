...
<head>
    ...
    <title>Đăng nhập - CareerGuide</title>
    ...
    <div
        ...
        <div class="text-center mb-6">
            <div class="inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary text-white">
                <i class="fa-solid fa-compass" style="color: rgb(29 78 216 / var(--tw-bg-opacity, 1)); font-size: 50px;"></i>
            </div>
            <h2 class="text-2xl font-bold text-primary mt-3">Đăng nhập CareerGuide</h2>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <button style="background: rgb(29 78 216 / var(--tw-bg-opacity, 1));" type="submit" class="w-full py-2 bg-primary text-white rounded-lg hover:bg-blue-700 transition">
                <i class="fa-solid fa-right-to-bracket mr-1"></i> Đăng nhập
            </button>

            <p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-3">
                Chưa có tài khoản?
                <a href="{{ route('user.register') }}" class="text-primary hover:underline">Đăng ký ngay</a>
            </p>
        </form>
    </div>
</body>
