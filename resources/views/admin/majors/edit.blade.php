...
@section('content')
    <div class="container-fluid">
        ...
        <h4 class="mb-4"><i class="fas fa-edit"></i> Chỉnh sửa ngành học</h4>
                ...
                <form method="POST" action="{{ route('majors.update', $major->id) }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            placeholder="Giới thiệu khái quát về ngành">{{ old('description', $major->description) }}</textarea>
                        @error('description')
                            <span class="text-danger small">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="requirements" id="requirements" rows="3"
                            ...
                            placeholder="Ví dụ: Học tốt Toán, Lý, Tin học...">{{ old('requirements', $major->requirements) }}</textarea>
                        @error('requirements')
                            <span class="text-danger small">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="career_opportunities" id="career_opportunities" rows="3"
                            ...
                            placeholder="Ví dụ: Lập trình viên, Kỹ sư phần mềm, Quản trị hệ thống...">{{ old('career_opportunities', $major->career_opportunities) }}</textarea>
